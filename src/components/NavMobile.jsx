...
function NavMobile() {
  return (
      <div className='col-12 d-flex justify-content-around fixed-bottom p-3 bg-black' >
            <span className=' '>
                <Link className='' to='/'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="beige" class="bi bi-house-door-fill" viewBox="0 0 16 16">
            ...
            <span className='' data-bs-toggle='modal' data-bd-target='#create'>
                {/* <Link to='/' className=''>                                        */}
            ...
            <span className=' '>
                <Link to='/viewplaylist' className=''>                                       
